...
### Required Context
`.agents/skills/logh7-wine-live-qa/SKILL.md`(필수 입력·fail-closed 조건), `docs/logh7-client-lineage-current.md`(EXE hash·sentinel·manifest), `.ai/known-issues.md`의 게이트 차단 현황.
### Output Format
...
.agents/skills/logh7-wine-live-qa/SKILL.md의 필수 입력(REPO_ROOT/WINE_BIN/WINEBOOT_BIN/
