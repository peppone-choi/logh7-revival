...
> **2026-07-20 실행 오버레이:** D0 설계 PR #232(`ec6d9b52`)와 A01 구현 PR #233(`43ee007a`)가 merge됐다. `1.0.0` schema·validator·고정 분모 adapter가 downstream 정본이며, A02/A04/A06/A09/A13이 첫 dependency-eligible 파동이다. 아래 P0→P1→P2→M4 기록은 폐기하지 않고 원장의 현행 증거·미해결 노드로 편입한다.
