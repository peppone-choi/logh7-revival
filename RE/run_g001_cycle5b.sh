...
SESSION=".omo/ui-explorer/g001-c002-cycle5b-20260623"
PORT=47900
...
# run read-only C002 probes (correct invocations)
python -m tools.logh7_c002_cmdmenu_probe --seconds 3 > "$SESSION/cmdmenu-probe.json" 2>&1 || true
python -m tools.logh7_c002_catgate_probe --cx 960 --cy 540 > "$SESSION/catgate-probe.json" 2>&1 || true
python -m tools.logh7_c002_widget_probe --cx 200 --cy 750 > "$SESSION/widget-probe-left.json" 2>&1 || true
python -m tools.logh7_c002_widget_probe --cx 1700 --cy 900 > "$SESSION/widget-probe-right.json" 2>&1 || true
