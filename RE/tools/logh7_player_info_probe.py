...
PLAYER_INFO_OFFICER_COUNT_OFFSET = 0x270
...
def probe(pid: int) -> dict[str, object]:
    ...
    for i in range(PLAYER_INFO_SLOTS):
        ...
        officer_count = table[base + PLAYER_INFO_OFFICER_COUNT_OFFSET]
        active.append({"slot": i, "idHex": f"0x{slot_id:08x}", "id": slot_id, "officerCount": officer_count})
