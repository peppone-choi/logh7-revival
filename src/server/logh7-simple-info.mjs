 ...
 * 0x0323 record). HIGH conf: first dword = character_id. Remaining 284 bytes carried via `bytes`.
...
export function buildNotifySimpleInfoCharacterInner(records = []) {
  ...
  return buildSimpleInfoDelta('character', records, (p, off, r) => writeIdAndBytes('characterId')(p, off, r, stride));
}
